...
@implementation LibellumNoteBackupViewController {
    ...
    - (void)viewDidLoad  {
        ...
        _viewBackupButton.backgroundColor = PrimaryColor;
        ...
        _backupNowButton.backgroundColor = PrimaryColor;
        ...
        _restoreBackupButton.backgroundColor = PrimaryColor;
        ...
        _deleteBackupButton.backgroundColor = PrimaryColor;
