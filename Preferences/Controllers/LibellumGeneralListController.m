#include "LibellumGeneralListController.h"

@implementation LibellumGeneralListController
	- (id)init {
		self = [super init];
	...
	- (void)viewDidAppear:(BOOL)animated {
		...
		if(!self.navigationItem.titleView) {
			UIImageView *iconView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"icons/general.png" inBundle:[self bundle] compatibleWithTraitCollection:nil]];
