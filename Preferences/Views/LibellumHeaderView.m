#import "LibellumHeaderView.h"

extern CFArrayRef CPBitmapCreateImagesFromData(CFDataRef cpbitmap, void*, int, void*);

@implementation LibellumHeaderView {
    UILabel *_title;
    UILabel *_subtitle;
	...
	- (instancetype)initWithTitle:(NSString *)title subtitles:(NSArray *)subtitles bundle:(NSBundle *)bundle {
		...
		if(self) {
			...
			_iconView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"icons/iconlarge.png" inBundle:bundle compatibleWithTraitCollection:nil]];
			_iconView.alpha = 0;
            ...
            if (@available(iOS 16, *)) {
                ...
                SBWallpaperController *wallpaperController = [wallpaperControllerClass sharedInstance];
                ...
                if (wallpaperRemoteController) {
                    ...
                    if (wallpaperViewController) {
                        ...
                        if (context) {
                            ...
                            wallpaper = UIGraphicsGetImageFromCurrentImageContext();
                        }
                        UIGraphicsEndImageContext();
                    }
                }
            } else {
                NSData *lockWallpaperData = [NSData dataWithContentsOfFile:jbroot(@"/var/mobile/Library/SpringBoard/OriginalLockBackground.cpbitmap")];
                ...
                if (lockWallpaperData) {
                    ...
                    if (imageArray && CFArrayGetCount(imageArray) > 0) {
                        wallpaper = [UIImage imageWithCGImage:(CGImageRef)CFArrayGetValueAtIndex(imageArray, 0)];
                    }
