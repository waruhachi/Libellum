#import "LibellumStyleOptionView.h"

@implementation LibellumStyleOptionView {
    UIStackView *_stackView;
    LibellumStyleCheckView *_checkView;
    ...
    - (instancetype)initWithFrame:(CGRect)frame appearanceOption:(id)option {
        ...
        if(self) {
            ...
            _checkView = [[LibellumStyleCheckView alloc] initWithFrame:CGRectZero];
