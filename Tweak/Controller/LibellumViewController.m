...
@implementation LibellumViewController {
    ...
    - (void)updatePreferences {
        ...
        self.customBackgroundColor = [GcColorPickerUtils colorWithHex:[self.preferences objectForKey:@"customBackgroundColor"]];
        self.customTextColor = [GcColorPickerUtils colorWithHex:[self.preferences objectForKey:@"customTextColor"]];
        self.lockColor = [GcColorPickerUtils colorWithHex:[self.preferences objectForKey:@"lockColor"]];
        self.customTintColor = [GcColorPickerUtils colorWithHex:[self.preferences objectForKey:@"customTintColor"]];

        self.borderColor = [GcColorPickerUtils colorWithHex:[self.preferences objectForKey:@"borderColor"]];
